...
const translations = {
  en: {
    ...
    'faq.a0': 'Diamo is a fitness app that automatically adapts your training to your menstrual cycle. It analyzes your cycle phase and creates a personalized daily workout plan using health data from Apple Health or Google Fit. Additionally, Diamo connects you with local fitness communities (Tribes) in your city.',
    'faq.q1': 'What is cycle-based training?',
    'faq.a1': 'Cycle-based training means adapting your workouts to the four phases of your menstrual cycle. During the follicular phase and around ovulation, you\'re more capable and can train more intensely. During the luteal phase and menstruation, you benefit from moderate sessions and recovery. Learn more in our detailed guide.',
    'faq.q2': 'Do I need special hardware or a smartwatch?',
    'faq.a2': 'No! Diamo works completely without any additional hardware. The app reads your health data directly from Apple Health (iPhone) or Google Fit (Android). If you also own a smartwatch or fitness tracker, Diamo can use that data too to fine-tune your training even further.',
  ...
  de: {
    ...
    'faq.a2': 'Nein! Diamo funktioniert komplett ohne zus\u00e4tzliche Hardware. Die App liest deine Gesundheitsdaten direkt aus Apple Health (iPhone) oder Google Fit (Android). Wenn du zus\u00e4tzlich eine Smartwatch oder einen Fitness-Tracker besitzt, kann Diamo diese Daten ebenfalls nutzen, um dein Training noch genauer anzupassen.',
