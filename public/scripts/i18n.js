...
const translations = {
  en: {
    ...
    'about.story.p1': 'We spent years following training plans that ignored the most fundamental part of our biology: our cycle. Plans that expected the same performance on day 5 and day 25. Plans that made us feel like failures when our bodies simply needed something different.',
    'about.story.p2': 'Then we learned the science: every woman moves through four distinct cycle phases, each shaping her energy, strength, and recovery in unique ways. This isn\'t a limitation. It\'s an advantage, if you know how to use it.',
    'about.story.p3': 'So we built Diamo. The app that finally trains with your cycle, not against it.',
    ...
    'about.team.title': 'Built by women, for women',
    'about.team.intro': 'We\'re not a big tech company. We\'re two friends who experienced firsthand how cycle-aware training changed everything and decided every woman deserves access to this.',
  ...
  de: {
    ...
    'about.story.p1': 'Wir haben jahrelang nach Trainingspl\u00e4nen trainiert, die den grundlegendsten Teil unserer Biologie ignoriert haben: unseren Zyklus. Pl\u00e4ne, die an Tag 5 und Tag 25 die gleiche Leistung erwartet haben. Pl\u00e4ne, die uns das Gef\u00fchl gegeben haben zu versagen, wenn unser K\u00f6rper einfach etwas anderes brauchte.',
    'about.story.p2': 'Dann haben wir die Wissenschaft dahinter verstanden: Jede Frau durchl\u00e4uft vier verschiedene Zyklusphasen, die ihre Energie, Kraft und Erholung auf einzigartige Weise beeinflussen. Das ist keine Einschr\u00e4nkung. Es ist ein Vorteil, wenn man ihn zu nutzen wei\u00df.',
    'about.story.p3': 'Also haben wir Diamo gebaut. Die App, die endlich mit deinem Zyklus trainiert, nicht gegen ihn.',
    ...
    'about.team.title': 'Von Frauen. F\u00fcr Frauen.',
    'about.team.intro': 'Wir sind kein gro\u00dfer Tech-Konzern. Wir sind zwei Freundinnen, die am eigenen K\u00f6rper erfahren haben, wie zyklusbewusstes Training alles ver\u00e4ndert und beschlossen haben, dass jede Frau Zugang dazu verdient.',
